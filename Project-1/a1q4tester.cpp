/*******************************************************************************/
/*                                                                             */
/*   a1 part 4 tester file                                                     */
/*                                                                             */
/*   To compile: g++ majorityelement.cpp a1q4tester.cpp timer.cpp -std=c++0x   */
/*                                                                             */
...
int main(void){
    ...
    std::string testSummary[numTests]={
                            "Simple testing on findCandidate()",
                            "Simple testing on majorityElement()",
                            "Testing findCandidate() on 100 element array",
                            "Testing majorityElement() on 100 element array",
                            "Testing findCandidate() on 5000 element array",
                            "Testing majorityElement() on 5000 element array",
                            "Testing findCandidate() on edge case with a majorityelement",
                            "Testing majorityElement() on edge case with a majorityelement",
                            "Testing findCandidate() on edge cases",
                            "Testing majorityElement() on edge cases",
                            "Timing Test on findCandidate()",
                            "Timing Test on majorityElement()"
};
    std::string msg;
    bool result=true;
    int numPassed=0;
...
bool test1(std::string& error){
    ...
    //the candidate for each of the arrays above.  If there are no candidates, -1
    int candidate[10]={5,5,8,-1,5,4,3,5,4,3} ;    
	int theCandidate=(rand()%2)?-rand():rand();
	bool correct=true;
	bool hasCandidate[10]={true,true,true,false,true,true,true,true,true,true};   
 
    for(int i=0;correct && i<10;i++){
        theCandidate = (rand()%2)?-rand():rand();
    	bool rc=findCandidate(data[i],theCandidate,sz[i]);
    	if(rc!=hasCandidate[i]){
            error = "Error 1a: findCandidate() function returned an incorrect value\n";
            error += "On data = {";
    		...
    		error += ((hasCandidate[i])?"true":"false");
    		error += "\nyour function is returning: ";
    		error += ((rc)?"true":"false");
    		correct=false;
    	}
    	else{
    		if(rc==true && candidate[i] !=theCandidate){
	    		error = "Error 1b: candidate found is not the correct value.\n";
    			error += "On data = {";
    			for(int j=0; j< sz[i] - 1;j++){
    				error += std::to_string(data[i][j]);
    				error += ",";
    			...
    			error += std::to_string(candidate[i]);
	    		error += "\nyour function is passed back: ";
    			error += std::to_string(theCandidate);
    			correct=false;
    		}
    	}
    }
...
bool test2(std::string& error){
    ...
    int majorElem=(rand()%2)?-rand():rand();
    bool correct=true;
    bool hasMajority[10]={false,false,false,false,true,true,true,true,true,false};   
 
    for(int i=0;correct && i<10;i++){
        majorElem=(rand()%2)?-rand():rand();
        bool rc=majorityElement(data[i],majorElem,sz[i]);
        if(rc!=hasMajority[i]){
            error = "Error 2a: majority element function returned an incorrect value\n";
            error += "On data = {";
            for(int j=0; j< sz[i] - 1;j++){
                error += std::to_string(data[i][j]);
                error += ",";
            ...
            if(rc==true && majority[i] !=majorElem){
                error = "Error 2b: majorityElement found is not the correct value.\n";
                error += "On data = {";
                for(int j=0; j< sz[i] - 1;j++){
                    error += std::to_string(data[i][j]);
                    error += ",";
...
bool test3(std::string& error){
    ...
    int theCandidate = (rand()%2)?-rand():rand();
   	bool rc=findCandidate(data,theCandidate,100);

   	bool correct = true;

    if(rc!=true){
    	error = "Error 3a: findCandidate() function returned an incorrect value\n";
    	error += "On data = {";
    	for(int j=0; j< 99;j++){
        ...
        if(theCandidate != 8){
            error = "Error 3b: candidate found is not the correct value.\n";
            error += "On data = {";
            ...
            error += std::to_string(data[99]);
            error +="}\nThe correct candidate is: 8";
            error += "\nyour function passed back: ";
            error += std::to_string(theCandidate);
            correct=false;
        }
    }
...
bool test4(std::string& error){
    ...
    bool correct = true;
    if(rc!=false){
        error = "Error 4: majority element function returned an incorrect value\n";
        error += "On data = {";
        for(int j=0; j< 99;j++){
                error += std::to_string(data[j]);
                error += ", ";
...
bool test5(std::string& error){
	...
	int theCandidate = (rand()%2)?-rand():rand();
	bool correct=true;
   	bool rc=findCandidate(data,theCandidate,5000);
    if(rc!=true){
    	error = "Error 5a: findCandidate() function returned an incorrect value\n";
    	error += "On data = {";
    	...
    	if(rc==true && theCandidate != 8){
			error = "Error 5b: candidate found is not the correct value.\n";
    		error += "On data = {";
    		for(int j=0; j< 4999 ;j++){
    			error += std::to_string(data[j]);
    			error += ",";
...
bool test7(std::string& error){
    ...
    int theCandidate = (rand()%2)?-rand():rand();
    bool correct=true;
    bool rc=findCandidate(data,theCandidate,63);

    if(rc!=true){
        error = "Error 7a: findCandidate() function returned an incorrect value\n";
        error += "On data = {";
        for(int j=0; j< 62 ;j++){
            error += std::to_string(data[j]);
            error += ",";
        ...
        if(rc==true && theCandidate != 1){
            error = "Error 7b: candidate found is not the correct value.\n";
            error += "On data = {";
            for(int j=0; j< 62 ;j++){
                error += std::to_string(data[j]);
                error += ",";
...
bool test8(std::string& error){
    ...
    if(rc!=true){
    	error = "Error 8a: majority element function returned an incorrect value\n";
    	error += "On data = {";
    	for(int j=0; j< 62 ;j++){
    		error += std::to_string(data[j]);
    		error += ",";
    	...
    	if(rc==true && majorElem != 1){
			error = "Error 8b: majorityElement found is not the correct value.\n";
    		error += "On data = {";
    		for(int j=0; j< 62 ;j++){
    			error += std::to_string(data[j]);
    			error += ",";
...
bool test9(std::string& error){
	...
	int theCandidate = (rand()%2)?-rand():rand();
	bool correct=true;
	bool rc=findCandidate(data,theCandidate,79);

    if(rc!=true){
    	error = "Error 9a: findCandidate() function returned an incorrect value\n";
    	error += "On data = {";
    	for(int j=0; j< 78 ;j++){
    		error += std::to_string(data[j]);
    		error += ",";
    	...
    	if(rc==true && theCandidate != 2){
			error = "Error 9b: candidate found is not the correct value.\n";
    		error += "On data = {";
    		for(int j=0; j< 78 ;j++){
    			error += std::to_string(data[j]);
    			error += ",";
...
bool test10(std::string& error){
    ...
    if(rc!=true){
        error = "Error 10a: majority element function returned an incorrect value\n";
        error += "On data = {";
        for(int j=0; j< 78 ;j++){
            error += std::to_string(data[j]);
            error += ",";
        ...
        if(rc==true && majorElem != 2){
            error = "Error 10b: majority element found is not the correct value.\n";
            error += "On data = {";
            for(int j=0; j< 78 ;j++){
                error += std::to_string(data[j]);
                error += ",";
...
bool test11(std::string& error){
	...
	Timer t;
	t.start();
	bool rc=findCandidate(data,theCandidate,131073);
	t.stop();
    if(rc!=true){
    	error = "Error 11a: findCandidate() function returned an incorrect value\n";
    	error +="}\nreturn value should be: true\n";
    	error += "\nyour function is returning: ";
    	error += ((rc)?"true":"false");
    	correct=false;
    	...
    	if(rc==true && theCandidate != 1){
			error = "Error 11b: candidate found is not the correct value.\n";
			error +="}\nThe correct candidate is: 1";
			error += "\nyour function is passed back: ";
    		error += std::to_string(theCandidate);
    		correct=false;
    ...
    if(correct){
		...
		data[131072]=2;
		t.start();
		rc=findCandidate(data,theCandidate,131073);
		t.stop();
	    if(rc!=true){
	    	error = "Error 11c: findCandidate() function returned an incorrect value\n";
	    	error +="}\nreturn value should be: true\n";
	    	error += "\nyour function is returning: ";
	    	error += ((rc)?"true":"false");
	    	correct=false;
	    	...
	    	if(rc==true && theCandidate != 2){
				error = "Error 11d: candidate found is not the correct value.\n";
				error +="}\nThe correct candidate is: 2";
				error += "\nyour function is passed back: ";
	    		error += std::to_string(theCandidate);
	    		correct=false;
	    	}
    ...
    if(correct){
		...
		t.stop();
        if(rc!=true){
            error = "Error 11e: findCandidate() function returned an incorrect value\n";
            error +="}\nreturn value should be: true\n";
            error += "\nyour function is returning: ";
            error += ((rc)?"true":"false");
            correct=false;
            ...
            if(rc==true && theCandidate != 3){
                error = "Error 11f: candidate found is not the correct value.\n";
                error +="}\nThe correct candidate is: 3";
                error += "\nyour function is passed back: ";
                error += std::to_string(theCandidate);
                correct=false;
            }
    ...
    if(correct){
        ...
        data[131072]=3;
		t.start();
		rc=findCandidate(data,theCandidate,131072);
		t.stop();
	    if(rc!=false){
	    	error = "Error 6f: findCandidate() function returned an incorrect value\n";
	    	error +="}\nreturn value should be: false\n";
	    	error += "\nyour function is returning: ";
	    	error += ((rc)?"true":"false");
	    	correct=false;
    ...
    if(correct){
    	std::cout << "131073 * 4 arrays processed by findCandidate() in " << t.currtime() << " seconds" << std::endl;
    }
...
bool test12(std::string& error){
    ...
    t.stop();
    if(rc!=true){
        error = "Error 12a: majority element function returned an incorrect value\n";
        error +="}\nreturn value should be: true\n";
        error += "\nyour function is returning: ";
        error += ((rc)?"true":"false");
        correct=false;
        ...
        if(rc==true && majorElem != 1){
            error = "Error 12b: majorityElement found is not the correct value.\n";
            error +="}\nThe correct majority element is: 1";
            error += "\nyour function is passed back: ";
            error += std::to_string(majorElem);
            correct=false;
    ...
    if(correct){
        ...
        t.stop();
        if(rc!=true){
            error = "Error 12c: majority element function returned an incorrect value\n";
            error +="}\nreturn value should be: true\n";
            error += "\nyour function is returning: ";
            error += ((rc)?"true":"false");
            correct=false;
            ...
            if(rc==true && majorElem != 2){
                error = "Error 12d: majorityElement found is not the correct value.\n";
    ...
    if(correct){
        ...
        t.stop();
        if(rc!=false){
            error = "Error 12e: majority element function returned an incorrect value\n";
            error +="}\nreturn value should be: false\n";
            error += "\nyour function is returning: ";
            error += ((rc)?"true":"false");
            correct=false;
    ...
    if(correct){
        ...
        t.stop();
        if(rc!=false){
            error = "Error 12f: majority element function returned an incorrect value\n";
            error +="}\nreturn value should be: false\n";
            error += "\nyour function is returning: ";
            error += ((rc)?"true":"false");
            correct=false;
    ...
    if(correct){
        std::cout << "131073 * 4 arrays processed by majority element in " << t.currtime() << " seconds" << std::endl;
    }
